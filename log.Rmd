...
```{r}
ggpairs(data.numeric[MDVP.small-2], ggplot2:: aes(color=patient.data$status, alpha = 0.5), progress = FALSE) + labs(caption = "Pair plot showing correlations between six MDVP attributes\n and showing how similar the status data is between them") + theme(axis.text.x = element_text(angle=90, hjust = 1),
...
```{r}
ggpairs(data.numeric[MDVP.shimmer-2], ggplot2:: aes(color=patient.data$status, alpha = 0.5), progress = FALSE) + labs(caption = "Pair plot showing correlations between six MDVP.shimmer attributes\n and showing how similar the status data is between them", legend = 1) + theme(axis.text.x = element_text(angle=90, hjust = 1), axis.text.y = element_blank(), legend.position = "bottom")                                                                  
```
