...
Also the data of NHR and HRN seem to affirm that they are opposite attributes of each other.
...
Boxplotting the data to show the differences for sick people and healthy people in MDVP measured attributes containing large numbers. 
...
From observing this data it can be concluded that healthy people are measured higher frequencies than sick people. Also log-transforming
successfully skewers outliers.
