...
Let's count the occurences by eye of all top six attributes and make a histogram to visualize the best attributes all round. The countings are added in a file called "best_features_counts.txt".
...
ggplot(best.features.counts, aes(x = features, fill = features)) + geom_bar() + xlab("Status") + 
