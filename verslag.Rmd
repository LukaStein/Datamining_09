...
**Tabel 3** Verschillen tussen klasse labels van drie attributen getoetst op alpha = 0.05.
| Attributes | P-values     |
|------------|--------------|
| Fo.Hz      | 3.121919e-08 |
| Fhi.Hz     | 0.02027567   |
...
**Tabel 4** Overzicht van de top drie modellen die hebben voorspeld, deze zijn getoetst in percentages.
...
**Tabel 5** Overzicht van de top drie modellen die hebben voorspeld, deze zijn getoetst op hoe relevant de verkregen informatie is en staat bekend als de F-maat.
...
**Tabel 6** Overzicht van alle niet overfitte modellen, deze zijn getoetst op hoeveel zieke mensen als gezond worden gemarkeerd in een marge tussen nul en één.
...
**Tabel 7** Verbeterde RandomForest en OneR met voorspellingen in procent goed
...
**Tabel 8** Attributen waar RandomForest het best op voorspeld.
...
**Tabel 9** Voorspellingen van zieke en gezonde mensen op basis van zes attributen.
...
Uit tabel 8 en figuur 8 werd duidelijk welke attributen het beste zijn om op te voorspellen. Uit de EDA vielen attributen NHR, MDVP.Flo.Hz/ MDVP.Fo.Hz / MDVP.Jitter.Abs.
