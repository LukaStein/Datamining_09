...
**Tabel 3** Verbeterde RandomForest en OneR met voorspellingen in procent goed
...
**Tabel 4** Attributen waar RandomForest het best op voorspeld.
...
Correctly Classified Instances         182               93.3333 %
Incorrectly Classified Instances        13                6.6667 
...
Gezond als ziek voorspeld |
Ziek goed voorspeld |
Gezond goed voorspeld | 
Totaal goed voorspeld (%) |
Totaal fout voorspeld (%) |

Uit de bovenstaande model en matrix is af te lezen dat voor 93.3333 procent goed wordt voorspeld wie gezond en ziek is. En in totaal worden er dertien fouten voorspellingen gemaakt.
